		...
		<section id="download-button" className="flex justify-center">
			...
			>
				<button
					...
					className="flex items-center gap-2 rounded border border-neutral-500 bg-neutral-200 px-4 py-2 text-neutral-950 transition hover:bg-neutral-50 disabled:opacity-50 dark:border-neutral-200 dark:bg-neutral-800 dark:text-neutral-50 dark:hover:bg-neutral-950"
				>
